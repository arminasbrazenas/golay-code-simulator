...
public class GolayEncoderTests
{
    ...
    {
        yield return [new List<byte> { 0b0010_0101, 0b1111_0000 }, new List<byte> { 0b0010_0101, 0b1111_1010, 0b1010_1000 }];
        yield return [new List<byte> { 0b0011_1110, 0b1110_0000 }, new List<byte> { 0b0011_1110, 0b1110_0100, 0b1001_0010 }];
        yield return [new List<byte> { 0b0000_1100, 0b0111_0000 }, new List<byte> { 0b0000_1100, 0b0111_0110, 0b1000_0000 }];
        yield return [new List<byte> { 0b0010_0100, 0b0000_0000 }, new List<byte> { 0b0010_0100, 0b0000_1111, 0b1010_0000 }];
        yield return
        [
